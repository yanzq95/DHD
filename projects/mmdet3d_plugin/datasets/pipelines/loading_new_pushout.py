...
class PointToMultiViewDepth_pushout(object):
    ...
    def __call__(self, results):
        ...
        keys_to_save = ["gt_depth","gt_height","sample_idx","canvas","pts_filename"]
        rusults_to_save = {key: results[key] for key in keys_to_save}
        import pickle;

        filename = f"pipeline_results_{cnt}.pkl"
        foldername= r'/opt/data/private/test/pipeline_results'
